...
/*
 * + I like how you used Lines to create the rectangle
 * 
 * - It completely depends on Line (coupling), if Line was taken out the code would fall apart
 * 
 * -It uses more memory
 * 
 * delta I think you can change the variable names to be less confusing
 * */
